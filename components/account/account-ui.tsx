...
// publicKey是否存在 钱包address是否有效
export function AccountChecker() {
  const { publicKey } = useWallet();
  if (!publicKey) {
    return null;
  }
  // 如果有publicKey 进入AccountBalanceCheck
  return <AccountBalanceCheck address={publicKey} />;
}
// 检查 如果query.isError  !query.data 显示空投
...
// 查找用户所有的Token Account 或者说 token
...
// AccountTransactions  Account所有的交易
